...
keys = [
    ...
    Key([mod], "i", lazy.to_screen(0), desc="Focus monitor 1"),
    Key([mod], "o", lazy.to_screen(1), desc="Focus monitor 2"),
    Key([mod], "p", lazy.to_screen(2), desc="Focus monitor 3"),
    Key(
        [mod],
        "f",
    ...
    Screen(
        ...
        top=bar.Bar(
            [
                ...
                widget.CheckUpdates(
                    update_interval=1800,
                    no_update_string="Arch linux-chan is happy",
                    distro="Arch_checkupdates",
                    display_format="{updates} updates",
                    foreground=colors["foreground"],
                    colour_have_updates=colors["foreground"],
