return {
  {
    ...
    config = function()
      require("shon.plugins.lsp.handlers").setup()
    end,
  },
    ...
    config = function(plugin, opts)
      ...
      require("mason-lspconfig").setup_handlers({
        function(server)
          ...
          local opts = {
            on_attach = require("shon.plugins.lsp.handlers").on_attach,
            capabilities = require("shon.plugins.lsp.handlers").capabilities,
          }

          local require_ok, conf_opts = pcall(require, "shon.plugins.lsp.settings." .. server)
          if require_ok then
        ...
        ["rust_analyzer"] = function()
          ...
          local require_ok, conf_opts = pcall(require, "shon.plugins.lsp.settings.rust_tools")
          if require_ok then
            opts = vim.tbl_deep_extend("force", conf_opts, opts)
          end
  ...
  },
  {
    ...
    keys = { -- LSP finder - Find the symbol's definition
      ...
      { "<leader>r",  "<cmd>Lspsaga show_line_diagnostics ++unfocus<CR>",   mode = "n" },

      -- Show cursor diagnostics
      -- Like show_line_diagnostics, it supports passing the ++unfocus argument
      { "<leader>R",  "<cmd>Lspsaga show_cursor_diagnostics ++unfocus<CR>", mode = "n" },
