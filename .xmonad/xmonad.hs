...
myStartupHook = composeAll
      [ spawnOnce "picom --config $HOME/.config/picom/picom.conf --experimental-backends", 
        spawnOnce "feh --bg-scale ~/Downloads/bob3.webp"
      ]
  ...
  xmonad $ ewmh def 
    ...
    , logHook            = dynamicLogWithPP $ xmobarPP
            ...
            { ppOutput = \x -> hPutStrLn xmproc x
              , ppCurrent = xmobarColor ("#f19cbb,"++color01) "" . wrap
                            "<fn=1><box type=Bottom width=3 color=#f19cbb>" "</box></fn>"
              ...
              , ppVisible = xmobarColor (color09++","++color01) "" . wrap 
                ...
                -- Hidden workspace
              , ppHidden = xmobarColor "#e68fac" "" . wrap
                           "<fn=1>" "</fn>" . clickable
              ...
              , ppTitle = xmobarColor "#f19cbb" "" . shorten 60

                -- Separator character
              , ppSep =  ("<fc="++color03++"> | </fc>")

                -- Urgent workspace
              , ppUrgent = xmobarColor "#F44747" "" 
